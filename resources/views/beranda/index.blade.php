...
<body class="g-sidenav-show  bg-gray-200">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/material-dashboard/pages/dashboard " target="_blank">
        ...
        <span class="ms-1 font-weight-bold text-white">Pengaduan Masyarakat</span>
      </a>
    </div>
  ...
  <script src="{{ asset('template1/assets/js/plugins/perfect-scrollbar.min.js')}}"></script>
  <script src="{{ asset('template1/assets/js/plugins/smooth-scrollbar.min.js')}}"></script>
  <script src="{{ asset('tempalte1/assets/js/plugins/chartjs.min.js')}}"></script>
  <script>
